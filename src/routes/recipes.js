...
routes.get("/:id/edit", session.userIsAdmin, recipes.edit); // Mostrar formulário de edição de receita
routes.put("/", multer.array("photos", 5), recipes.put); // Editar uma receita
routes.delete("/", session.userIsAdmin, recipes.delete); // Deletar uma receita
